...
[![Travis CI](https://travis-ci.org/greg-1-anderson/starter-test-69.svg?branch=master)](https://travis-ci.org/greg-1-anderson/starter-test-69)
[![Windows CI](https://ci.appveyor.com/api/projects/status/r7k214bjyqsg9t6q?svg=true)](https://ci.appveyor.com/project/greg-1-anderson/starter-test-69)
[![Scrutinizer Code Quality](https://scrutinizer-ci.com/g/greg-1-anderson/starter-test-69/badges/quality-score.png?b=master)](https://scrutinizer-ci.com/g/greg-1-anderson/starter-test-69/?branch=master)
[![Coverage Status](https://coveralls.io/repos/github/greg-1-anderson/starter-test-69/badge.svg?branch=master)](https://coveralls.io/github/greg-1-anderson/starter-test-69?branch=master) 
...
[![License](https://poser.pugx.org/greg-1-anderson/starter-test-69/license)](https://github.com/greg-1-anderson/starter-test-69//master/LICENSE)
-->
...
| Feature                   | Setup
| ------------------------- | ----------------
| Collaborative repository  | [DONE](https://github.com/greg-1-anderson/starter-test-69)
| Linux permutation testing | [DONE](https://travis-ci.org/greg-1-anderson/starter-test-69)
| Windows testing           | [DONE](https://ci.appveyor.com/project/greg-1-anderson/starter-test-69)
| Static analysis           | [DONE](https://scrutinizer-ci.com/g/greg-1-anderson/starter-test-69/)
...
deploy:
  ...
  on:
    tags: true
    repo: greg-1-anderson/starter-test-69
```
...
We use [SemVer](http://semver.org/) for versioning. For the versions available, see the [tags on this repository](https://github.com/greg-1-anderson/starter-test-69/tags). 

## Authors

* **Greg Anderson** - created project from template.

See also the list of [contributors](https://github.com/greg-1-anderson/starter-test-69/contributors) who participated in this project.
